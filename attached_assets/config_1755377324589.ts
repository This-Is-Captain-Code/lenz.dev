...
export const SNAP_GROUP_ID = 'b5551368-7881-4a23-a034-a0e757ec85a7'; // Updated group ID
export const DEFAULT_LENS_ID = '49a28a50-9294-475b-bdb5-d0b7395109e2'; // Specific lens ID
